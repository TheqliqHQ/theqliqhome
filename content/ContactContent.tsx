...
const FIELDS: Field[] = [
  ...
  { id: "message", label: "Why do you want to work with us?", type: "textarea", placeholder: "Tell us about yourself", required: true, colSpan: "full" },
];
...
export default function ContactContent({
  ...
  // simple controlled values (but we won’t over-engineer)
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    // TODO: wire this to your /api/contact or a third-party form
  ...
  return (
    <div className="space-y-14 md:space-y-16">
      {/* ——— Hero section: left copy / right form ——— */}
      <section
        className="
          rounded-[28px]
          bg-[#eaf2f5]  /* soft ice tint like the ref */
          p-6 md:p-8
        "
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
          {/* Left: chip, headline, copy, email, distributed, socials */}
          ...
          <div>
            <form
              onSubmit={onSubmit}
              className="rounded-2xl bg-white p-5 md:p-6 border border-slate-200"
            >
